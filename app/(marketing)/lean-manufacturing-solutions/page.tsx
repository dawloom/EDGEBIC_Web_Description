...
export const metadata: Metadata = {
  ...
  description: 'Lean manufacturing solutions to eliminate waste, improve efficiency, and maximize value in your production processes.',
  openGraph: {
    title: 'Lean Manufacturing Solutions',
    description: 'Streamline production and eliminate waste with lean manufacturing',
