                        ...
                        <Card className="mb-8">
                            <CardHeader>
                                <CardTitle className="text-center text-3xl">
                                    Two-Machine Scheduling Optimization
                                </CardTitle>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                <p className="text-lg leading-relaxed text-muted-foreground">
                                    SKED2A provides advanced two-machine scheduling optimization
                                    for manufacturing environments with sequential processing
                                    requirements. This specialized module optimizes job
                                    sequencing, resource allocation, and workflow coordination
                                    across two interconnected production machines or workstations.
                                </p>
