                ...
                <div className="container mx-auto px-4">
                    <div className="mx-auto max-w-4xl text-center">
                        ...
                        <p className="mb-8 text-xl md:text-2xl">
                            Advanced two-machine scheduling and resource optimization system
                        </p>
            ...
            <section className="py-16">
                <div className="container mx-auto px-4">
                    <div className="mx-auto max-w-4xl">
                        <Card className="mb-8">
                            <CardHeader>
                                <CardTitle className="text-center text-3xl">Two-Machine Scheduling Optimization</CardTitle>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                <p className="text-lg leading-relaxed text-muted-foreground">
                                    SKED2A provides advanced two-machine scheduling optimization for manufacturing environments with sequential processing requirements. This specialized module optimizes job sequencing, resource allocation, and workflow coordination across two interconnected production machines or workstations.
                                </p>
