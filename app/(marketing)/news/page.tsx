    ...
    return (
        <div className="container mx-auto px-4 py-20">
            ...
            <section className="mb-20">
                <h2 className="mb-10 text-3xl font-semibold">Sample Media Coverage</h2>
                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="overflow-hidden rounded-lg bg-white shadow-md dark:bg-gray-800">
                        ...
                        <div className="p-6">
                            <h3 className="mb-3 text-lg font-semibold">
                                Production Scheduling System for Amish Woodshop Cuts Lead Time,
                                Inefficiency
                            </h3>
                            <p className="mb-4 text-sm text-muted-foreground">
                                Woodworking Network
                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                    ...
                    <div className="rounded-lg border p-6">
                        <h4 className="mb-3 text-lg font-semibold">
                            User Solutions, Inc. announces revolutionary method for Production
                            Planning and Scheduling evaluations
                        </h4>
                        <p className="mb-3 text-sm text-muted-foreground">Oct, 29, 2023</p>
                        <Link
                    ...
                    <div className="rounded-lg border p-6">
                        ...
                        <p className="mb-3 text-sm text-muted-foreground">Oct, 28, 2023</p>
                        <Link
                    ...
                    <div className="rounded-lg border p-6">
                        ...
                        <p className="mb-3 text-sm text-muted-foreground">Oct, 04, 2023</p>
                        <Link
                        ...
                        <div className="md:w-2/3">
                            <h3 className="mb-3 text-xl font-semibold">
                                ...
                                >
                                    ...
                                    Tracking Tools from User Solutions, Inc. to Become More
