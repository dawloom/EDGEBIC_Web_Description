...
export const ContactFormEmail = ({
  ...
  <Html>
    ...
    <Body style={{ margin: 'auto', backgroundColor: '#f6f9fc', fontFamily: 'Arial, sans-serif' }}>
            ...
            <Section style={{
              ...
              <Row>
                ...
                <Column style={{ verticalAlign: 'middle' }}>
                  <Text style={{ margin: 0, fontSize: '12px', color: '#64748b' }}>Email Address</Text>
                  <Link href={`mailto:${email}`} style={{ fontSize: '15px', fontWeight: 500, color: '#2563eb', textDecoration: 'none' }}>
                    {email}
                  </Link>
                </Column>
              </Row>
            ...
            {phone && (
              <Section style={{
                ...
                <Row>
                  ...
                  <Column style={{ verticalAlign: 'middle' }}>
                    <Text style={{ margin: 0, fontSize: '12px', color: '#64748b' }}>Phone Number</Text>
                    <Link href={`tel:${phone}`} style={{ fontSize: '15px', fontWeight: 500, color: '#1e293b', textDecoration: 'none' }}>
                      {phone}
                    </Link>
                  </Column>
                </Row>
            ...
            <Row>
              <Column style={{ paddingRight: '8px', width: '50%' }}>
                <Section style={{
                  ...
                  <Text style={{ margin: 0, fontSize: '12px', color: '#64748b' }}>Product Interest</Text>
                  <Text style={{ margin: '4px 0 0 0', fontSize: '15px', fontWeight: 600, color: '#1e293b' }}>
                    {productInterest}
                  </Text>
                </Section>
              </Column>
              <Column style={{ paddingLeft: '8px', width: '50%' }}>
                <Section style={{
                  ...
                  <Text style={{ margin: 0, fontSize: '12px', color: '#64748b' }}>How They Found Us</Text>
                  <Text style={{ margin: '4px 0 0 0', fontSize: '15px', fontWeight: 600, color: '#1e293b' }}>
                    {hearAboutUs}
                  </Text>
                </Section>
