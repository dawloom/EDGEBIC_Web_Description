...
export default function ThankYouDownloadTrendsmoothPage() {
  return (
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="mx-auto max-w-7xl">
            ...
            <p className="mb-6 text-xl md:text-2xl">
              Your Trend & Smoothing download should begin shortly
            </p>
          </div>
        </div>
      </section>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <p className="text-center">
                  Your Trend & Smoothing software download should begin
