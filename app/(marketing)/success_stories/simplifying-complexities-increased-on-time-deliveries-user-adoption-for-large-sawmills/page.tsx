...
export default function SimplifyingComplexitiesSawmillsPage() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-indigo-50 via-white to-blue-50 py-6 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-7xl text-center">
            ...
            <h1 className="mb-6 bg-gradient-to-r from-indigo-600 to-blue-600 bg-clip-text text-3xl font-bold text-transparent md:text-4xl lg:text-5xl">
              Simplifying Complexities Increased On-Time Deliveries User Adoption
              for Large Sawmills
            </h1>
            <p className="mx-auto mb-4 max-w-3xl text-xl text-gray-700 dark:text-gray-300">
              Discover how simplifying complex processes led to improved delivery
              performance in sawmill operations.
            </p>
          </div>
        </div>
      </section>
