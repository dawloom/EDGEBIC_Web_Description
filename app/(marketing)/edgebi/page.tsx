                    ...
                    <div className="mx-auto max-w-6xl">
                        ...
                        <div className="mb-16 text-center">
                            ...
                            <p className="mb-6 text-xl text-muted-foreground md:text-2xl">
                                EDGEBI stands for Enhanced Drag-n-drop Graphical Environment
                                with Business Intelligence
                            </p>
                            <p className="mb-8 text-lg text-muted-foreground">
                                A graphical overlay for Resource Manager DB. Finally, you can
                                manage your production scheduling with an intuitive graphical
                                approach that can be easily customized.
                            </p>
