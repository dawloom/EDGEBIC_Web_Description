...
export const metadata: Metadata = {
  title:
    'Cook Compression Scheduling Software Review | User Solutions',
  description:
          ...
          <div className="mx-auto max-w-7xl">
            <div className="prose prose-lg dark:prose-invert mx-auto">
              ...
              <div className="my-8 rounded-lg bg-amber-50 p-8 dark:bg-gray-700">
                ...
                <p className="text-lg text-gray-700 dark:text-gray-300">
                  My experience with User Solutions, Inc. has set a higher standard
                  for my internet business dealings and software vendor expertise.
                ...
                <p className="text-lg text-gray-700 dark:text-gray-300">
                  ...
                  <span className="font-semibold">User Solutions, Inc.</span> are
                  world class in response, knowledge, and support of your product
                  line in meeting my company's need.
                </p>
              ...
              <div className="mt-8 rounded-lg border-2 border-amber-300 bg-gradient-to-r from-amber-100 to-yellow-100 p-6 dark:border-amber-600 dark:from-gray-700 dark:to-gray-600">
                ...
                <ul className="list-disc space-y-3 pl-6 text-gray-700 dark:text-gray-300">
                  <li className="text-lg">
                    <span className="font-semibold">World-Class Personnel:</span>{' '}
                    Product and Sales teams excel in response time, knowledge, and
                    support
                  </li>
                  <li className="text-lg">
                  ...
                  <li className="text-lg">
                    <span className="font-semibold">High Fidelity:</span> Company
                    faithfulness and reliability in every interaction
                  </li>
                  <li className="text-lg">
                    <span className="font-semibold">Timely Follow Through:</span>{' '}
              ...
              <div className="mt-8 rounded-lg bg-amber-50 p-6 text-center dark:bg-gray-700">
                ...
                <p className="mt-2 italic text-gray-600 dark:text-gray-400">
                  "I will whole heartedly recommend User Solutions as I see need in
