                ...
                <div className="grid gap-12 md:grid-cols-3">
                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        <p className="text-base leading-relaxed text-slate-700 dark:text-slate-300">
                            Generate reliable, detailed production plans. Balance materials and
                            capacity with actual demand. Effortlessly reschedule production orders.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        <p className="text-base leading-relaxed text-slate-700 dark:text-slate-300">
                            Always know what you have in stock. Easily avoid inventory shortages and
                            excess. Track inventory by lot or batch, use serial numbers and
                            barcodes.
                        </p>
                    </div>
