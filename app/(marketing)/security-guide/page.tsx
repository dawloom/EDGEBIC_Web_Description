                ...
                <Card className="mb-16">
                    ...
                    <CardContent>
                        <p className="text-lg leading-relaxed text-muted-foreground">
                            ...
                            programs, you may have to do some\all of the following steps after
                            downloading:
                        </p>
                    </CardContent>
                </Card>
                ...
                <Card className="mb-16">
                    ...
                    <CardContent>
                        <div className="grid items-start gap-8 md:grid-cols-2">
                            <div>
                                <p className="text-lg leading-relaxed text-muted-foreground">
                                    Wherever you save file, using windows explorer, right click on
                                    said file and choose properties and unblock for security.
                    ...
                    <CardContent>
                        <div className="space-y-8">
                            <p className="text-lg leading-relaxed text-muted-foreground">
                                ...
                                see if Developer is option on main menu for Excel. If not, then
                                go to File, Options, and add Developer to ribbon.
                            </p>
