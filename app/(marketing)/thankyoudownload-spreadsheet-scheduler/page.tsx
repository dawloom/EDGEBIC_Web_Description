...
export default function ThankYouDownloadSpreadsheetSchedulerPage() {
    return (
                ...
                <div className="container mx-auto px-4 text-center">
                    <div className="mx-auto max-w-7xl">
                        ...
                        <p className="mb-6 text-xl md:text-2xl">
                            Your Spreadsheet Scheduler download should begin shortly
                        </p>
                    </div>
                </div>
            </section>
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-6">
                                <p className="text-center">
                                    Your Spreadsheet Scheduler software download should begin
